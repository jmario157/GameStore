                    ...
                    <div className="cards-wrapper">
                        <div className="card">
                            ...
                            <div className="card__image">
                                <img src="/img/Lords.jpg" alt="Tarjeta 1" />
                            </div>
                        ...
                        <div className="card">
                            <div className="like-overlay"><i className="fa fa-heart"></i></div>
                            <div className="card__image">
                                <img src="/img/Ufc.jpg" alt="Tarjeta 2" />
                            </div>
                            <div className="card__content">
                        ...
                        <div className="card">
                            <div className="like-overlay"><i className="fa fa-heart"></i></div>
                            <div className="card__image">
                                <img src="/img/Lords.jpg" alt="Tarjeta 3" />
                            </div>
                            <div className="card__content">
                        ...
                        <div className="card">
                            <div className="like-overlay"><i className="fa fa-heart"></i></div>
                            <div className="card__image">
                                <img src="/img/Forza.jpg" alt="Tarjeta 4" />
                            </div>
                            <div className="card__content">
                        ...
                        <div className="card">
                            <div className="like-overlay"><i className="fa fa-heart"></i></div>
                            <div className="card__image">
                                <img src="/img/Ufc.jpg" alt="Tarjeta 5" />
                            </div>
                            <div className="card__content">
                                <h2 className="card__title">Netflix Gift Card</h2>
                                <p className="card__description">Desde 150 Lps</p>
                        ...
                        <div className="card">
                            <div className="like-overlay"><i className="fa fa-heart"></i></div>
                            <div className="card__image">
                                <img src="/img/Lords.jpg" alt="Tarjeta 6" />
                            </div>
                            <div className="card__content">
                                <h2 className="card__title">Netflix Gift Card</h2>
                                <p className="card__description">Desde 150 Lps</p>
                        ...
                        <div className="card">
                            <div className="like-overlay"><i className="fa fa-heart"></i></div>
                            <div className="card__image">
                                <img src="/img/Forza.jpg" alt="Tarjeta 8" />
                            </div>
                            <div className="card__content">
                                <h2 className="card__title">Netflix Gift Card</h2>
                                <p className="card__description">Desde 150 Lps</p>
                        ...
                        <div className="card">
                            <div className="like-overlay"><i className="fa fa-heart"></i></div>
                            <div className="card__image">
                                <img src="/img/Ufc.jpg" alt="Tarjeta 9" />
                            </div>
                            <div className="card__content">
                                <h2 className="card__title">Netflix Gift Card</h2>
                                <p className="card__description">Desde 150 Lps</p>
